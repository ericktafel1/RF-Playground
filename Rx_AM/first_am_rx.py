...
# Title: AM Receiver
# Description: My 1st AM radio receiver
...
class first_am_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/gigs/Documents/SDR/getting_started_sdr-main/getting_started_sdr-main/ch_04/am_broadcast_02_c900k_s400k.iq', True, 0, 0)
